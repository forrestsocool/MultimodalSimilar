...
if __name__ == '__main__':
    ...
    pretrained_model = BertModel.from_pretrained('/home/ma-user/modelarts/inputs/huggingface_2/roberta_ext')
    tokenizer = BertTokenizer.from_pretrained('/home/ma-user/modelarts/inputs/huggingface_2/roberta_ext')
    model = NlpClassifier(pretrained_model, 10205)
    ...
    # read custom data
    data_files = {
        "train": "/home/ma-user/modelarts/inputs/data_input_0/daodian_data_v2/train.pqt",
        "test": "/home/ma-user/modelarts/inputs/data_input_0/daodian_data_v2/test.pqt"}
    ...
    tokenized_datasets = tokenized_datasets.rename_column("tag_id", "labels")
    ...
    for epoch in range(num_epochs):
        for step, batch in enumerate(train_dataloader, start=1):
            ...
            # save model
            if global_step % 1000 == 0:
                torch.save(model,'/home/ma-user/modelarts/outputs/data_output_0/{}.pt'.format(global_step))
    # model.eval()
    # for batch in test_dataloader:
    #     batch = {k: v.to(device) for k, v in batch.items()}
    #     with torch.no_grad():
